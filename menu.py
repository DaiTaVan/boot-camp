...
url_camera_phone = phone_menu.add.text_input('Enter the url: ',default='http://10.1.17.229:4747/video')
phone_menu.add.button('Start',get_url_and_start)
phone_menu.add.button('Back',pygame_menu.events.BACK)
phone_menu.add.button('Exit',pygame_menu.events.EXIT)
# second menu
...
second_menu.add.button('Back',pygame_menu.events.BACK)
